...
class Student {
    ...
    private int[] marks; // stores 3 subject marks
    ...
    public String getResultStatus() {
        for (int m : marks) {
            if (m < 35) return "Fail"; // if any subject < 35 → fail
        }
        return "Pass";
    }
...
public class ResultManagementSystem {
    ...
    public ResultManagementSystem() {
        students = new Student[100]; // store max 100 students
        count = 0;
    ...
    // Add student with validation & custom exception
    public void addStudent() throws InvalidMarksException {
        ...
        try {
            ...
            Student s = new Student(roll, name, marks); // may throw InvalidMarksException
            students[count++] = s;
